                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="buy-tab" role="tabpanel">
                            <div class="mx-4">
                                <form action="<?php echo e(route('summarizeText')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-group mb-3">
                                        <label>Article :</label>
                                        <textarea name="article" id="" cols="30" rows="4" required class="form-control" placeholder="Type/Paste newspaper article"><?php if(Session('original')): ?><?php echo e(Session('original')); ?><?php endif; ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="tab-pane" id="sell-tab" role="tabpanel">
                            <div class="mx-4">
                                <form action="<?php echo e(route('summarizeDocument')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-group mb-3">
                                        <label>Article (Word documents only):</label>
                                        <input type="file" name="doc" id="" required class="form-control" accept=".doc, .docx">
                                        <?php $__errorArgs = ['doc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if(Session('summarized')): ?>
        <div class="row mt-5">
            <div class="col-xl-10 offset-xl-1 px-4">
                <h3 class="text-bold">Result of summarized text</h3>
                <?php $__currentLoopData = Session('summarized'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <p><?php echo e($p); ?></p>
...
</html><?php /**PATH /home/odeh/Desktop/Development/Laravel Projects/ets/resources/views/welcome.blade.php ENDPATH**/ ?>